...
get_service_names() -> ['matrixop.MatrixOp'].


get_service_def('matrixop.MatrixOp') ->
    {{service, 'matrixop.MatrixOp'},
     [#{name => 'Echo', input => matrix, output => matrix,
	input_stream => true, output_stream => true,
	opts => []},
      #{name => 'Op', input => matrix_op_request,
	output => matrix_list, input_stream => false,
	output_stream => false, opts => []}]};
get_service_def(_) -> error.


get_rpc_names('matrixop.MatrixOp') -> ['Echo', 'Op'];
get_rpc_names(_) -> error.


find_rpc_def('matrixop.MatrixOp', RpcName) ->
    'find_rpc_def_matrixop.MatrixOp'(RpcName);
find_rpc_def(_, _) -> error.


'find_rpc_def_matrixop.MatrixOp'('Echo') ->
    #{name => 'Echo', input => matrix, output => matrix,
      input_stream => true, output_stream => true,
      opts => []};
'find_rpc_def_matrixop.MatrixOp'('Op') ->
    #{name => 'Op', input => matrix_op_request,
      output => matrix_list, input_stream => false,
      output_stream => false, opts => []};
'find_rpc_def_matrixop.MatrixOp'(_) -> error.
